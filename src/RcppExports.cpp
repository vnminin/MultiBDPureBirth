...
RcppExport SEXP _MultiBDPureBirth_SIR_Cpp(SEXP tSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP S0SEXP, SEXP I0SEXP, SEXP Ap1SEXP, SEXP Bp1SEXP, SEXP directionSEXP, SEXP nblocksSEXP, SEXP tolSEXP, SEXP computeModeSEXP, SEXP nThreadsSEXP) {
BEGIN_RCPP
...
// SIR_pure_birth_Cpp
std::vector<double> SIR_pure_birth_Cpp(const double t, const double alpha, const double beta, const long int S0, const long int I0, const int Ap1, const int Bp1, const int direction, const int nblocks, const double tol, const int computeMode, const int nThreads);
RcppExport SEXP _MultiBDPureBirth_SIR_pure_birth_Cpp(SEXP tSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP S0SEXP, SEXP I0SEXP, SEXP Ap1SEXP, SEXP Bp1SEXP, SEXP directionSEXP, SEXP nblocksSEXP, SEXP tolSEXP, SEXP computeModeSEXP, SEXP nThreadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const double >::type t(tSEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type computeMode(computeModeSEXP);
    Rcpp::traits::input_parameter< const int >::type nThreads(nThreadsSEXP);
    rcpp_result_gen = Rcpp::wrap(SIR_pure_birth_Cpp(t, alpha, beta, S0, I0, Ap1, Bp1, direction, nblocks, tol, computeMode, nThreads));
    return rcpp_result_gen;
END_RCPP
}
// bb_lt_invert_Cpp
...
RcppExport SEXP _MultiBDPureBirth_bb_lt_invert_Cpp(SEXP tSEXP, SEXP lambda1SEXP, SEXP lambda2SEXP, SEXP Ap1SEXP, SEXP Bp1SEXP, SEXP directionSEXP, SEXP nblocksSEXP, SEXP tolSEXP, SEXP computeModeSEXP, SEXP nThreadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _MultiBDPureBirth_bbd_lt_invert_Cpp(SEXP tSEXP, SEXP a0SEXP, SEXP b0SEXP, SEXP lambda1SEXP, SEXP lambda2SEXP, SEXP mu2SEXP, SEXP gammaSEXP, SEXP xSEXP, SEXP ySEXP, SEXP ASEXP, SEXP Bp1SEXP, SEXP nblocksSEXP, SEXP tolSEXP, SEXP computeModeSEXP, SEXP nThreadsSEXP, SEXP maxdepthSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type t(tSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_MultiBDPureBirth_SIR_Cpp", (DL_FUNC) &_MultiBDPureBirth_SIR_Cpp, 12},
    {"_MultiBDPureBirth_SIR_pure_birth_Cpp", (DL_FUNC) &_MultiBDPureBirth_SIR_pure_birth_Cpp, 12},
    {"_MultiBDPureBirth_bb_lt_invert_Cpp", (DL_FUNC) &_MultiBDPureBirth_bb_lt_invert_Cpp, 10},
    {"_MultiBDPureBirth_bbd_lt_invert_Cpp", (DL_FUNC) &_MultiBDPureBirth_bbd_lt_invert_Cpp, 16},
    {NULL, NULL, 0}
};

RcppExport void R_init_MultiBDPureBirth(DllInfo *dll) {
